...
public class Controller {
    ...
    public static void requestTotalUsers(boolean display){
        ...
        AView.getTotalUsersViewInstance("Total Users:", totalUsers, display);
    }
    ...
    public static void requestTotalGroups(boolean display){
        ...
        AView.getTotalGroupsViewInstance("Total Groups:", totalGroups, display);
    }
    ...
    public static void requestTotalMessages(boolean display){
        ...
        AView.getTotalMessagesViewInstance("Total Messages:", totalMessages, display);
    }
